...
const ProductStatus = () => {
  ...
  // Filter products based on user email
  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="flex-1 ml-0 md:ml-16 p-4">
        <h2 className="text-xl font-bold mb-4">Products & Reviews</h2>
        <h3 className="text-base mb-4 text-stone-600">
          Please refresh the page if you don't see any updates or products.
        </h3>
          ...
          <div key={product._id} className="mb-8">
            <div className="flex flex-col md:flex-row items-center mb-2">
              <img
                ...
                alt="Company Image"
                className="w-20 h-20 rounded-lg md:mr-4 mb-4 md:mb-0"
              />
              <h3 className="text-lg font-semibold">{product.companyName}</h3>
            </div>
            <button
              className="text-green-500 hover:text-green-700 focus:outline-none mb-4"
              onClick={() => toggleExpand(product._id)}
            >
              {expandedProduct === product._id ? 'Hide Reviews' : 'See Reviews'}
            </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {productReviews[product._id] &&
                  productReviews[product._id].map((review) => (
                    <div
                      key={review._id}
                      className="bg-gray-100 rounded-lg p-4 border-2 border-stone-300"
                    >
                      <div className="flex items-center mb-2">
                        <img
